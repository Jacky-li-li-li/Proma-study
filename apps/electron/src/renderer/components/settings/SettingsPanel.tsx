...
import { Settings, Radio, BarChart3, Palette, Info, Plug, Globe, BookOpen, Wrench, MessageSquare, GraduationCap, X, Keyboard } from 'lucide-react'
...
const BASE_TABS: TabItem[] = [
  ...
  { id: 'usage', label: '用量', icon: <BarChart3 size={16} /> },
