...
const electronAPI: ElectronAPI = {
  ...
  getModelUsageStats: () => {
    return ipcRenderer.invoke(CHAT_IPC_CHANNELS.GET_MODEL_USAGE_STATS)
  },
  ...
  readLocalImage: (imagePath: string, basePath?: string) => {
    return ipcRenderer.invoke(CHAT_IPC_CHANNELS.READ_LOCAL_IMAGE, imagePath, basePath)
  },
